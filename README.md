...
- [InfiniteYou](https://github.com/bytedance/InfiniteYou) — Jiang et al., ByteDance, arXiv:2503.16418, March 2025. FLUX-DiT identity preservation via InfuseNet residual injection; the newest-backbone identity-conditioned foundation model with fully public release as of early 2026. See [Ch08](08-diffusion-parametric.md).
- [Vox2Face](https://www.mdpi.com/2078-2489/17/2/200) — MDPI *Information* 17(2):200, 2026. The first published template for projecting a non-face semantic embedding (speech) into ArcFace space and driving frozen Arc2Face. Two-stage training: AM-Softmax + InfoNCE alignment and SDS self-consistency with LoRA adapters. See [Ch08](08-diffusion-parametric.md).
- [HyperFace](https://arxiv.org/abs/2411.08470) — Boutros et al., late 2025. Formulates synthetic identity generation as a packing problem on the ArcFace hypersphere; no paired data or labels required. The most useful published substitute for Vox2Face's supervised Stage I when the adopter has no ground-truth pairs. See [Ch08](08-diffusion-parametric.md).
...
- [FEM / Face Reconstruction from Embeddings](https://arxiv.org/abs/2602.13168) — Han, Li, Denzler, AAAI 2026. KAN-based adapter mapping face-recognition embeddings into a pretrained identity-preserving diffusion model; a 2026 instance of the direct-embedding pattern and a case study in KAN-vs-MLP projection design. See [Ch08](08-diffusion-parametric.md).
- [RigFace](https://huggingface.co/mengtingwei/rigface) — Wei et al., arXiv:2502.02465, full SD 1.5 fine-tune with dedicated identity UNet. **Weights only on HuggingFace (Apache-2.0); no inference code released, the linked GitHub URL is 404.** See [Ch08](08-diffusion-parametric.md).
